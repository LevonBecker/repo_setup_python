---
name: update
description: Use for template_python version and upgrade requests: check Python, library, or workflow-action versions, update configs, run upgrades, sync dependencies, /update, or /upgrade equivalents.
---
